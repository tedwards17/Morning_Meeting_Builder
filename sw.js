...
const CACHE='mmb-shell-round2-repair';
const URLS=["./", "./assets/index-BCa4LCTt-fixed.js", "./assets/index-BSPHUTIz.css", "./assets/index-Cf7UMjii-rPXAYMDb.js", "./assets/web-B2skKh-g-DeSIeTvh.js", "./assets/web-CvhwepZE-Bpyq98_s.js", "./assets/web-g5t7OFMZ-DJI_yc43.js", "./icon-192.png", "./icon-512.png", "./icon.svg", "./index.html", "./manifest.webmanifest"];
